...
public interface AdocaoControllerOpenAPI {
    ...
    @Operation(summary = "Listar todas as adoções", description = "Retorna o histórico completo de todas as adoções (pendentes, aprovadas e reprovadas).")
    @ApiResponse(responseCode = "200", description = "Adoções listadas com sucesso")
    ResponseEntity<List<AdocaoResponseDTO>> buscarTodos();

    @Operation(summary = "Buscar adoção por ID", description = "Retorna os detalhes de uma solicitação de adoção específica.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Solicitar adoção", description = "Abre uma nova solicitação de adoção de um pet para um tutor. Valida regras de negócio (pet já adotado, limite de adoções, etc).")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Aprovar adoção", description = "Aprova uma solicitação de adoção que está com status pendente.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Reprovar adoção", description = "Reprova uma solicitação de adoção pendente. Exige uma justificativa (motivo).")
    @ApiResponses(value = {
